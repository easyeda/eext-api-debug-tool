			...
			buildDom(
				[
					...
					[
						'tr',
						null,
						['td', { colspan: 2 }, ['table', { role: 'presentation', id: 'more-controls' }, this.renderOptionGroup(optionGroups.More)]],
					],
...
define('ace/ext/settings_menu', ['require', 'exports', 'module', 'ace/ext/options', 'ace/ext/menu_tools/overlay_page', 'ace/editor'], function (
	require,
	exports,
	module,
) {
