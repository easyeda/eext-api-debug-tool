	...
	module.exports = (function () {
	...
	})()(
		{
				...
				function (_dereq_, module, exports) {
					...
					var JSHINT = (function () {
						...
						function doMethod(classToken, context, name, generator) {
							...
							doFunction(context, { name: name, type: generator ? 'generator' : null, isMethod: true, statement: classToken });
						}
						...
						prefix('(', function (context, rbp) {
							...
							if (!isNecessary && (isOperator(first) || first !== last)) {
								isNecessary =
									rbp > first.lbp || (rbp > 0 && rbp === first.lbp) || (!isEndOfExpr() && last.rbp < state.tokens.next.lbp);
							}
					...
					var scopeManager = function (state, predefined, exported, declared) {
						...
						var scopeManagerInst = {
							...
							addbinding: function (bindingName, opts) {
								...
								var ishoisted =
									type === 'function' || type === 'generator function' || type === 'async function' || type === 'import';
								var isexported =
			...
			'/../node_modules/assert/assert.js': [
				...
				{ 'object-assign': '/../node_modules/object-assign/index.js', 'util/': '/../node_modules/assert/node_modules/util/util.js' },
			],
