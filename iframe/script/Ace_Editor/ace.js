(function () {
	...
	define(
		...
		function (e, t, n) {
			...
			var r = e('./oop'),
				...
				o = {
					...
					setOption: function (e, t) {
						...
						if (!n) return u('misspelled option "' + e + '"');
			...
			(f.prototype.warn = u), (f.prototype.reportError = s), r.implement(f.prototype, i), (t.AppConfig = f);
		},
	),
			...
			(t.setLoader = function (e) {
				...
				(t.loadModule = function (e, n) {
					...
					var o = function (r) {
						...
						var o = function () {
							a(e, function (n, r) {
								r && (t.$loaded[e] = r), t._emit('load.module', { name: e, module: r });
								var i = t.$loading[e];
								(t.$loading[e] = null),
			...
			var r = e('../lib/event'),
				...
				y = function (e, t) {
					...
					(this.setNumberOfExtraLines = function (e) {
						...
						(this.$focusScroll = !1),
						(this.focus = function () {
							this.setAriaOptions({ setLabel: t.renderer.enableKeyboardAccessibility });
							if (S || c || this.$focusScroll == 'browser') return n.focus({ preventScroll: !0 });
							var e = n.style.top;
					...
					var $ = function (e) {
						...
						J = function () {
							...
							if (w.useTextareaForIME) t.onCompositionUpdate(n.value);
								...
								q(e),
									w.markerRange &&
										(w.context && (w.markerRange.start.column = w.selectionStart = w.context.compositionStartOffset),
					...
					r.addListener(n, 'compositionstart', $, t),
						...
						(this.onContextMenu = function (e) {
							(I = !0), H(), t._emit('nativecontextmenu', { target: t, domEvent: e }), this.moveToMouse(e, !0);
						}),
	...
	define('ace/tooltip', ['require', 'exports', 'module', 'ace/lib/dom', 'ace/lib/event', 'ace/range'], function (e, t, n) {
		'use strict';
		var r =
				(this && this.__extends) ||
				(function () {
		...
		var h = (function (e) {
			function t(t) {
				...
				return (
					...
					r.addEventListener('wheel', o.stopPropagation),
					n
				);
			}
			return (
				...
				(t.prototype.showForRange = function (e, t, n, r) {
					...
					var s = e.renderer;
					this.isOpen || (c.addPopup(this), this.$registerCloseEvents(), this.setTheme(s.theme)),
						(this.isOpen = !0),
					...
					o.pageY - l < 0 && o.pageY < p && (d = !1),
						...
						(f.style.left = Math.min(o.pageX, window.innerWidth - h - i) + 'px');
				}),
				...
				(t.prototype.hide = function (e) {
					...
					(this.lastEvent = null),
						...
						this.addMarker(null),
						this.isOpen &&
							(this.$removeCloseEvents(), (this.getElement().style.display = 'none'), (this.isOpen = !1), c.removePopup(this));
				}),
	...
	define(
		...
		function (e, t, n) {
			...
			function f(e) {
				...
				function f() {
					i && (i = clearTimeout(i)), r.isOpen && (r.hideTooltip(), t.off('mousewheel', f));
				}
				function c(e) {
				...
				return (
					...
					(t.prototype.showTooltip = function (e) {
						var n = this.editor.renderer.$gutterLayer,
							r = n.$annotations[e],
							i;
						r ? (i = { text: Array.from(r.text), type: Array.from(r.type) }) : (i = { text: [], type: [] });
						...
						for (var a = 0; a < i.text.length; a++) {
							var d = "<span class='ace_"
								.concat(i.type[a], ' ')
								.concat(p, "' aria-label='")
								.concat(t.annotationLabels[i.type[a].replace('_fold', '')].singular, "' role=img> </span> ")
								.concat(i.text[a]);
						...
						e.closeDocComment !== !1 &&
							this.add('doc comment end', 'insertion', function (e, t, n, r, i) {
								if (e === 'doc-start' && (i === '\n' || i === '\r\n') && n.selection.isEmpty()) {
									...
									if (/\s*\*/.test(u))
										return /^\s*\*/.test(o)
											? { text: i + a + '* ', selection: [1, 3 + a.length, 1, 3 + a.length] }
											: { text: i + a + ' * ', selection: [1, 3 + a.length, 1, 3 + a.length] };
									if (/\/\*\*/.test(o.substring(0, s.column)))
										return { text: i + a + ' * ' + i + ' ' + a + '*/', selection: [1, 4 + a.length, 1, 4 + a.length] };
								}
							});
				};
	...
	define('ace/unicode', ['require', 'exports', 'module'], function (e, t, n) {
		'use strict';
		var r = [
				48, 9, 8, 25, 5, 0, 2, 25, 48, 0, 11, 0, 5, 0, 6, 22, 2, 30, 2, 457, 5, 11, 15, 4, 8, 0, 2, 0, 18, 116, 2, 1, 3, 3, 9, 0, 2, 2, 2, 0,
				2, 19, 2, 82, 2, 138, 2, 4, 3, 155, 12, 37, 3, 0, 8, 38, 10, 44, 2, 0, 2, 1, 2, 1, 2, 0, 9, 26, 6, 2, 30, 10, 7, 61, 2, 9, 5, 101, 2,
				7, 3, 9, 2, 18, 3, 0, 17, 58, 3, 100, 15, 53, 5, 0, 6, 45, 211, 57, 3, 18, 2, 5, 3, 11, 3, 9, 2, 1, 7, 6, 2, 2, 2, 7, 3, 1, 3, 21, 2,
				6, 2, 0, 4, 3, 3, 8, 3, 1, 3, 3, 9, 0, 5, 1, 2, 4, 3, 11, 16, 2, 2, 5, 5, 1, 3, 21, 2, 6, 2, 1, 2, 1, 2, 1, 3, 0, 2, 4, 5, 1, 3, 2, 4,
				0, 8, 3, 2, 0, 8, 15, 12, 2, 2, 8, 2, 2, 2, 21, 2, 6, 2, 1, 2, 4, 3, 9, 2, 2, 2, 2, 3, 0, 16, 3, 3, 9, 18, 2, 2, 7, 3, 1, 3, 21, 2, 6,
				2, 1, 2, 4, 3, 8, 3, 1, 3, 2, 9, 1, 5, 1, 2, 4, 3, 9, 2, 0, 17, 1, 2, 5, 4, 2, 2, 3, 4, 1, 2, 0, 2, 1, 4, 1, 4, 2, 4, 11, 5, 4, 4, 2,
				2, 3, 3, 0, 7, 0, 15, 9, 18, 2, 2, 7, 2, 2, 2, 22, 2, 9, 2, 4, 4, 7, 2, 2, 2, 3, 8, 1, 2, 1, 7, 3, 3, 9, 19, 1, 2, 7, 2, 2, 2, 22, 2,
				9, 2, 4, 3, 8, 2, 2, 2, 3, 8, 1, 8, 0, 2, 3, 3, 9, 19, 1, 2, 7, 2, 2, 2, 22, 2, 15, 4, 7, 2, 2, 2, 3, 10, 0, 9, 3, 3, 9, 11, 5, 3, 1,
				3, 5, 3, 5, 3, 2,
			],
			i = 0,
			s = [];
					...
					return (
						...
						(e.prototype.$splitAndapplyLargeDelta = function (e, t) {
							...
							for (var o = 0, u = 0; o < r; o = u) {
								...
								var a = n.slice(o, u);
								a.push(''),
									this.applyDelta({ start: this.pos(i + o, s), end: this.pos(i + u, (s = 0)), action: e.action, lines: a }, !0);
							}
	...
	define('ace/search_highlight', ['require', 'exports', 'module', 'ace/lib/lang', 'ace/range'], function (e, t, n) {
		...
		var r = e('./lib/lang'),
			...
			s = (function () {
				function e(e, t, n) {
					n === void 0 && (n = 'text'), this.setRegexp(e), (this.clazz = t), (this.type = n);
				}
				return (
				...
				v = (function () {
					...
					return (
						...
						(e.prototype.getScreenWidth = function () {
							return (
								this.$computeWidth(), this.lineWidgets ? Math.max(this.getLineWidgetMaxWidth(), this.screenWidth) : this.screenWidth
							);
						}),
										...
										? ((o = []),
											u.walk(
												function (e, t, r, i) {
													var s;
													if (e != null) {
														(s = this.$getDisplayTokens(e, o.length)), (s[0] = y);
						...
						(e.prototype.$getStringScreenWidth = function (e, t, n) {
							...
							for (i = 0; i < e.length; i++) {
								(r = e.charCodeAt(i)), r == 9 ? (n += this.getScreenTabSize(n)) : r >= 4352 && T(r) ? (n += 2) : (n += 1);
								if (n > t) break;
							}
							return [n, i];
						}),
				...
				return (
					...
					(e.prototype.$matchIterator = function (e, t) {
						...
						var i = t.backwards == 1,
							...
							u = t.range,
							a = t.start;
						a || (a = u ? u[i ? 'end' : 'start'] : e.selection.getRange()), a.start && (a = a[s != i ? 'end' : 'start']);
						...
						if (i)
							var c = function (e) {
								...
								if (t.wrap == 0) return;
								for (n = l, f = a.row; n >= f; n--) if (p(n, Number.MAX_VALUE, e)) return;
							};
						else
							var c = function (e) {
								var n = a.row;
							...
							this.editor.isRowVisible(t) || this.editor.scrollToLine(t, !0, !0),
								setTimeout(
									function () {
										...
										if (t !== null && n === null) {
											(this.activeRowIndex = t), (this.activeLane = 'fold'), this.$focusFoldWidget(this.activeRowIndex);
											return;
										}
					...
					(e.prototype.$moveFoldWidgetUp = function () {
						...
						while (e > 0) {
							...
							if (this.$isFoldWidgetVisible(e)) {
								this.$blurFoldWidget(this.activeRowIndex), (this.activeRowIndex = e), this.$focusFoldWidget(this.activeRowIndex);
								return;
							}
						}
						return;
				...
				N = (function () {
					...
					return (
						...
						(e.prototype.getCopyText = function () {
							...
							var o = { text: e };
							return this._signal('copy', o), (x.lineMode = n ? o.text : !1), o.text;
						}),
						...
						(e.prototype.setGhostText = function (e, t) {
							this.session.widgetManager ||
								((this.session.widgetManager = new w(this.session)), this.session.widgetManager.attach(this)),
							...
							e
								? ((this.renderer.enableKeyboardAccessibility = !0),
									...
									this.renderer.scroller.setAttribute(
										'aria-label',
										S('Editor content, press Enter to start editing, press Escape to exit'),
									),
									...
									this.renderer.$gutter.setAttribute(
										'aria-label',
										S('Editor gutter, press Enter to interact with controls using arrow keys, press Escape to exit'),
									),
					...
					return (
						...
						(e.prototype.setAnnotations = function (e) {
							...
							for (var t = 0; t < e.length; t++) {
								...
								var o = n.text,
									u = n.type;
								(o = o ? s.escapeHTML(o) : n.html || ''), i.text.indexOf(o) === -1 && (i.text.push(o), i.type.push(u));
								var a = n.className;
								a
									? (i.className = a)
									: u == 'error'
						...
						(e.prototype.$renderCell = function (e, t, n, i) {
							...
							this.$highlightGutterLine &&
								(i == this.$cursorRow || (n && i < this.$cursorRow && i >= g && this.$cursorRow <= n.end.row)) &&
							...
							if (S) {
								...
								L
									? f.setAttribute('aria-label', a('Toggle code folding, rows $0 through $1', [L.start.row + 1, L.end.row + 1]))
									: n
										? f.setAttribute('aria-label', a('Toggle code folding, rows $0 through $1', [n.start.row + 1, n.end.row + 1]))
										: f.setAttribute('aria-label', a('Toggle code folding, row $0', [i + 1])),
									T
										? (f.setAttribute('aria-expanded', 'false'), f.setAttribute('title', a('Unfold code')))
										: (f.setAttribute('aria-expanded', 'true'), f.setAttribute('title', a('Fold code')));
							} else
								f &&
					...
					return (
						...
						(e.prototype.$renderToken = function (e, t, n, r) {
							...
							if (!f(n.type)) {
								...
								n.type == 'fold' &&
									((b.style.width = n.value.length * this.config.characterWidth + 'px'), b.setAttribute('title', a('Unfold code'))),
									(b.className = w),
									b.appendChild(u),
									e.appendChild(b);
				...
				return (
					...
					(e.prototype.setGhostText = function (e, t) {
						...
						this.addToken(i[0], 'ghost_text', r.row, r.column),
							(this.$ghostText = { text: e, position: { row: r.row, column: r.column } });
						if (i.length > 1) {
							(this.$ghostTextWidget = { text: i.slice(1).join('\n'), row: r.row, column: r.column, className: 'ace_ghost_text' }),
					...
					(e.prototype.removeGhostText = function () {
						...
						this.removeExtraToken(e.row, e.column),
							this.$ghostTextWidget &&
								(this.session.widgetManager.removeLineWidget(this.$ghostTextWidget), (this.$ghostTextWidget = null)),
							(this.$ghostText = null);
					}),
					...
					(e.prototype.$addResizeObserver = function () {
						...
						(this.$resizeTimer = s.delayedCall(function () {
							...
							(this.$resizeObserver = new window.ResizeObserver(function (t) {
								...
								Math.abs(e.$size.width - n) > 1 || Math.abs(e.$size.height - r) > 1
									? e.$resizeTimer.delay()
	...
	define(
		...
		function (e, t, n) {
			...
			(t.showErrorMarker = function (e, t) {
				...
				var p = { row: s.row, fixedWidth: !0, coverGutter: !0, el: i.createElement('div'), type: 'errorMarker' },
				...
				var g = function (e, t, n) {
					if (t === 0 && (n === 'esc' || n === 'return')) return p.destroy(), { command: 'null' };
				};
				(p.destroy = function () {
					...
					e.renderer.scrollCursorIntoView(null, 0.5, { bottom: p.el.offsetHeight });
			}),
				i.importCssString(
