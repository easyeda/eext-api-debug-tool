define(
	...
	function (e, t, n) {
		...
		var d = (function () {
			...
			return (
							...
							for (var i = 0; i < t.length; i++) {
								...
								if (typeof u == 'object') {
									...
									if (u.changeCase && u.local) {
										...
										a &&
											typeof a == 'string' &&
											(u.changeCase == 'u' ? (t[i] = a[0].toUpperCase()) : (t[i] = a[0].toLowerCase()),
											(t[i + 1] = a.substr(1)));
				...
				(e.prototype.insertSnippet = function (e, t, n) {
					n === void 0 && (n = {});
					var r = this;
					if (e.inVirtualSelectionMode) return r.insertSnippetForSelection(e, t, n);
					e.forEachSelection(
						function () {
				...
				(e.prototype.register = function (e, t) {
					...
					function a(e) {
						...
						n[t].push(e),
							...
							e.tabTrigger &&
								!e.trigger &&
								(!e.guard && /^\w/.test(e.tabTrigger) && (e.guard = '\\b'), (e.trigger = o.escapeRegExp(e.tabTrigger)));
		...
		var v = function (e, t, n) {
				...
				(u = this.resolveVariables(u, e)),
					(u = u.map(function (e) {
						return e == '\n' && !n.excludeExtraIndent ? e + o : typeof e == 'string' ? e.replace(/\t/g, s) : e;
					}));
				var a = [];
				u.forEach(function (e, t) {
					...
					o && !r.value ? (r.value = s) : s.length && (!r.value || typeof r.value != 'string') && (r.value = s.join(''));
				}),
				...
				p = (function () {
					function e(e) {
						...
						e && e.appendChild(t),
							...
							n.renderer.$textLayer.element.setAttribute('role', l.isSafari ? 'menu' : 'listbox'),
							n.renderer.$textLayer.element.setAttribute('aria-roledescription', f('Autocomplete suggestions')),
							n.renderer.$textLayer.element.setAttribute('aria-label', f('Autocomplete suggestions')),
						...
						(n.focus = r),
							...
							n.on('mousedown', function (e) {
								...
								n.selection.moveToPosition(t), (d.start.row = d.end.row = t.row), e.stop();
							});
						var i,
							p = new s(-1, 0, -1, Infinity),
							d = new s(-1, 0, -1, Infinity);
						(d.id = n.session.addMarker(d, 'ace_active-line', 'fullLine')),
							(n.setSelectOnHover = function (e) {
								e
									? p.id && (n.session.removeMarker(p.id), (p.id = null))
									: (p.id = n.session.addMarker(p, 'ace_line-hover', 'fullLine'));
							}),
							...
							n.on('mousemove', function (e) {
								...
								(i = e), (i.scrollTop = n.renderer.scrollTop), (n.isMouseOver = !0);
								var t = i.getDocumentPosition().row;
								p.start.row != t && (p.id || n.setRow(t), m(t));
							}),
							n.renderer.on('beforeRender', function () {
								if (i && p.start.row != -1) {
									i.$pos = null;
									var e = i.getDocumentPosition().row;
									p.id || n.setRow(e), m(e, !0);
								}
							}),
							n.renderer.on('afterRender', function () {
								...
								if (r) {
									...
									(r.id = s),
										...
										r.setAttribute('role', l.isSafari ? 'menuitem' : 'option'),
										r.setAttribute('aria-roledescription', f('item')),
										r.setAttribute('aria-label', n.getData(e).value),
										r.setAttribute('aria-setsize', n.data.length),
										r.setAttribute('aria-posinset', e + 1),
										r.setAttribute('aria-describedby', 'doc-tooltip'),
						...
						var v = function () {
							...
							m = function (e, t) {
								e !== p.start.row &&
									((p.start.row = p.end.row = e), t || n.session._emit('changeBackMarker'), n._emit('changeHoverMarker'));
							};
						...
						return (
							...
							(n.setRow = function (e) {
								(e = Math.max(this.autoSelect ? 0 : -1, Math.min(this.data.length - 1, e))),
									d.start.row != e &&
							...
							(n.tryShow = function (e, t, r, s) {
								...
								var o = this.container,
									...
									f = this.renderer,
									l = f.$maxLines * t * 1.4,
									c = { top: 0, bottom: 0, left: 0 },
									h = u - e.top - 3 * this.$borderSize - t,
									p = e.top - 3 * this.$borderSize;
								r || (p <= h || h >= l ? (r = 'bottom') : (r = 'top')),
									r === 'top'
										? ((c.bottom = e.top - this.$borderSize), (c.top = c.bottom - l))
										: r === 'bottom' && ((c.top = e.top + t + this.$borderSize), (c.bottom = c.top + l));
								var d = c.top >= 0 && c.bottom <= u;
								if (!s && !d) return !1;
								d ? (f.$maxPixelHeight = null) : r === 'top' ? (f.$maxPixelHeight = p) : (f.$maxPixelHeight = h),
									r === 'top'
										? ((o.style.top = ''), (o.style.bottom = u - c.bottom + 'px'), (n.isTopdown = !1))
										: ((o.style.top = c.top + 'px'), (o.style.bottom = ''), (n.isTopdown = !0)),
									(o.style.display = '');
								var v = e.left;
								return (
									v + o.offsetWidth > a && (v = a - o.offsetWidth),
									(o.style.left = v + 'px'),
									(o.style.right = ''),
	...
	define('ace/autocomplete/inline_screenreader', ['require', 'exports', 'module'], function (e, t, n) {
		'use strict';
		var r = (function () {
			function e(e) {
				(this.editor = e),
					...
					!this.popup &&
						...
						this.popup.renderer.on(
							...
							function () {
								...
								if (n) {
									var r = 'doc-tooltip ';
									for (var i = 0; i < this._lines.length; i++) r += 'ace-inline-screenreader-line-'.concat(i, ' ');
	...
	define('ace/autocomplete/inline', ['require', 'exports', 'module', 'ace/snippets', 'ace/autocomplete/inline_screenreader'], function (e, t, n) {
		'use strict';
			...
			s = (function () {
				...
				return (
					(e.prototype.show = function (e, t, n) {
						(n = n || ''), e && this.editor && this.editor !== e && (this.hide(), (this.editor = null), (this.inlineScreenReader = null));
						if (!e || !t) return !1;
						this.inlineScreenReader || (this.inlineScreenReader = new i(e));
						var s = t.snippet ? r.getDisplayTextForSnippet(e, t.snippet) : t.value;
					...
					(e.prototype.destroy = function () {
						this.hide(),
							(this.editor = null),
							this.inlineScreenReader && (this.inlineScreenReader.destroy(), (this.inlineScreenReader = null));
					}),
					e
				);
			})();
	...
	define('ace/autocomplete/util', ['require', 'exports', 'module'], function (e, t, n) {
		...
		(t.retrievePrecedingIdentifier = function (e, t, n) {
			...
			(t.triggerAutocomplete = function (e) {
				var t = e.getCursorPosition(),
					n = e.session.getLine(t.row),
					r = t.column === 0 ? 0 : t.column - 1,
					i = n[r];
				return e.completers.some(function (e) {
					if (e.triggerCharacters && Array.isArray(e.triggerCharacters)) return e.triggerCharacters.includes(i);
				});
			});
	}),
	define(
		...
		function (e, t, n) {
				...
				d = (function () {
					function e() {
						(this.autoInsert = !1),
							...
							(this.tooltipTimer = a.delayedCall(this.updateDocTooltip.bind(this), 50)),
							(this.popupTimer = a.delayedCall(this.$updatePopupPosition.bind(this), 50)),
							...
							(this.$firstOpenTimer = a.delayedCall(
								function () {
									var t = this.completionProvider && this.completionProvider.initialPosition;
									if (this.autoShown || (this.popup && this.popup.isOpen) || !t) return;
									(this.completions = new m(e.completionsForLoading)),
					...
					return (
						...
						(e.prototype.$init = function () {
							return (
								(this.popup = new i(this.parentNode || document.body || document.documentElement)),
								this.popup.on(
									'click',
									function (e) {
								...
								h.addListener(this.popup.container, 'mouseout', this.mouseOutListener.bind(this)),
						...
						(e.prototype.$onPopupChange = function (e) {
							if (this.inlineRenderer && this.inlineEnabled) {
								var t = e ? null : this.popup.getData(this.popup.getRow()),
									n = u.getCompletionPrefix(this.editor);
								this.inlineRenderer.show(this.editor, t, n) ? this.$seen(t) : this.inlineRenderer.hide();
						...
						(e.prototype.$onPopupRender = function () {
							...
							if (this.completions && this.completions.filtered && this.completions.filtered.length > 0)
								for (var t = this.popup.getFirstVisibleRow(); t <= this.popup.getLastVisibleRow(); t++) {
						...
						(e.prototype.$onPopupShow = function (e) {
							this.$onPopupChange(e),
								(this.stickySelection = !1),
								this.stickySelectionDelay >= 0 && this.stickySelectionTimer.schedule(this.stickySelectionDelay);
						}),
						...
						(e.prototype.unObserveLayoutChanges = function () {
							var e = this;
							window.removeEventListener('resize', this.onLayoutChange, { passive: !0 }),
								window.removeEventListener('wheel', this.mousewheelListener),
								this.$elements &&
									this.$elements.forEach(function (t) {
										t.removeEventListener('scroll', e.onLayoutChange, { passive: !0 });
									}),
								(this.$elements = null);
						}),
						...
						(e.prototype.$updatePopupPosition = function () {
							...
							(r.top += i.top - t.layerConfig.offset), (r.left += i.left - e.renderer.scrollLeft), (r.left += t.gutterWidth);
						...
						(e.prototype.openPopup = function (e, t, n) {
							this.$firstOpenTimer.cancel(),
								...
								this.inlineEnabled && !this.inlineRenderer && this.$initInline(),
							...
							this.popup.setData(this.completions.filtered, this.completions.filterText),
								this.editor.textInput.setAriaOptions &&
									this.editor.textInput.setAriaOptions({ activeDescendant: o(this.popup.getRow()), inline: this.inlineEnabled }),
							...
							this.popup.setRow(this.autoSelect ? s : -1),
								s === r && i !== this.completions.filtered[s] && this.$onPopupChange(),
								n
									? n && !t && this.detach()
						...
						(e.prototype.detach = function () {
							this.editor &&
								...
								this.popup && this.popup.renderer && this.popup.renderer.off('afterRender', this.$onPopupRender),
						...
						(e.prototype.insertMatch = function (e, t) {
							...
							var n = this.completions,
								r = this.getCompletionProvider().insertMatch(this.editor, e, n.filterText, t);
						...
						(e.prototype.getCompletionProvider = function (e) {
							return this.completionProvider || (this.completionProvider = new v(e)), this.completionProvider;
						}),
						...
						(e.prototype.updateCompletions = function (t, n) {
							if (t && this.base && this.completions) {
								var r = this.editor.getCursorPosition(),
									i = this.editor.session.getTextRange({ start: this.base, end: r });
							...
							if (n && n.matches) {
								...
								return (
									(this.base = this.editor.session.doc.createAnchor(r.row, r.column)),
									(this.base.$insertRight = !0),
									(this.completions = new m(n.matches)),
							...
							(this.base = s.doc.createAnchor(r.row, r.column - i.length)), (this.base.$insertRight = !0);
							var o = { exactMatch: this.exactMatch, ignoreCaption: this.ignoreCaption };
							this.getCompletionProvider({ prefix: i, pos: r }).provideCompletions(
								this.editor,
								o,
								function (n, r, i) {
									var s = r.filtered,
									...
									if (i) {
										...
										if (s.length == 1 && s[0].value == o && !s[0].snippet) return this.detach();
										if (this.autoInsert && !this.autoShown && s.length == 1) return this.insertMatch(s[0]);
									}
									(this.completions = !i && this.showLoadingState ? new m(e.completionsForLoading.concat(s), r.filterText) : r),
										this.openPopup(this.editor, o, t),
						...
						(e.prototype.showDocTooltip = function (e) {
							...
							e.docHTML ? (n.innerHTML = e.docHTML) : e.docText && (n.textContent = e.docText),
								n.parentNode || this.popup.container.appendChild(this.tooltipNode);
							var r = this.popup,
								i = r.container.getBoundingClientRect();
							(n.style.top = r.container.style.top),
								(n.style.bottom = r.container.style.bottom),
									...
									? i.left < 320
										? r.isTopdown
											? ((n.style.top = i.bottom + 'px'),
												...
												(n.style.right = ''),
												(n.style.bottom = ''))
											: ((n.style.top = r.container.offsetTop - n.offsetHeight + 'px'),
												(n.style.left = i.left + 'px'),
												(n.style.right = ''),
												(n.style.bottom = ''))
										: ((n.style.right = window.innerWidth - i.left + 'px'), (n.style.left = ''))
						...
						(e.prototype.destroy = function () {
							...
							this.editor && this.editor.completer == this && (this.editor.off('destroy', p), (this.editor.completer = null)),
			...
			(d.prototype.commands = {
				...
				(d.for = function (e) {
					return e.completer instanceof d
						? e.completer
						: (e.completer && (e.completer.destroy(), (e.completer = null)),
							c.get('sharedPopups')
								? (d.$sharedInstance || (d.$sharedInstance = new d()), (e.completer = d.$sharedInstance))
								: ((e.completer = new d()), e.once('destroy', p)),
							e.completer);
				}),
				(d.startCommand = {
			...
			var v = (function () {
					...
					return (
						(e.prototype.insertByIndex = function (e, t, n) {
							return !this.completions || !this.completions.filtered ? !1 : this.insertMatch(e, this.completions.filtered[t], n);
						}),
						(e.prototype.insertMatch = function (e, t, n) {
							if (!t) return !1;
							e.startOperation({ command: { name: 'insertMatch' } });
							if (t.completer && t.completer.insertMatch) t.completer.insertMatch(e, t);
							else {
								...
								if (r || i) {
									var s;
									e.selection.getAllRanges ? (s = e.selection.getAllRanges()) : (s = [e.getSelectionRange()]);
									for (var o = 0, u; (u = s[o]); o++) (u.start.column -= r), (u.end.column += i), e.session.remove(u);
								}
								t.snippet ? l.insertSnippet(e, t.snippet) : this.$insertString(e, t),
									t.completer && t.completer.onInsert && typeof t.completer.onInsert == 'function' && t.completer.onInsert(e, t),
									t.command && t.command === 'startAutocomplete' && e.execCommand(t.command);
							}
							...
							return (
								e.completers.forEach(function (a, f) {
									a.getCompletions(e, n, r, i, function (n, r) {
										a.hideInlinePreview &&
											(r = r.map(function (e) {
												return Object.assign(e, { hideInlinePreview: a.hideInlinePreview });
											})),
											!n && r && (s = s.concat(r)),
											t(null, { prefix: u.getCompletionPrefix(e), matches: s, finished: --o === 0 });
									});
								}),
								!0
							);
					...
					return (
						...
						(e.prototype.filterCompletions = function (e, t) {
							...
							e: for (var s = 0, o; (o = e[s]); s++) {
								var u = (!this.ignoreCaption && o.caption) || o.value || o.snippet;
								if (!u) continue;
								var a = -1,
									f = 0,
									l = 0,
			...
			(t.Autocomplete = d), (t.CompletionProvider = v), (t.FilteredList = m);
		},
	),
		...
		function (e, t, n) {
			...
			var r = e('../snippets').snippetManager,
				...
				c = {
					...
					getDocTooltip: function (e) {
						e.snippet &&
							!e.docHTML &&
							(e.docHTML = ['<b>', o.escapeHTML(e.caption), '</b>', '<hr></hr>', o.escapeHTML(l(e.snippet))].join(''));
					},
					id: 'snippetCompleter',
				},
				h = [c, a, f];
			...
			var p = {
				...
				w = function (e) {
					var t = e.editor,
						...
						r = u.triggerAutocomplete(t);
					if ((n && n.length >= t.$liveAutocompletionThreshold) || r) {
						var s = i.for(t);
						(s.autoShown = !0), s.showPopup(t);
					}
				},
				E = e('../editor').Editor;
			e('../config').defineOptions(E.prototype, 'editor', {
				enableBasicAutocompletion: {
					set: function (e) {
						e
							? (this.completers || (this.completers = Array.isArray(e) ? e : h), this.commands.addCommand(i.startCommand))
				...
				enableLiveAutocompletion: {
					set: function (e) {
						e
							? (this.completers || (this.completers = Array.isArray(e) ? e : h), this.commands.on('afterExec', g))
							: this.commands.off('afterExec', g);
					},
					value: !1,
				},
				...
				enableSnippets: {
					set: function (e) {
						e
							? (this.commands.addCommand(p), this.on('changeMode', d), d(null, this))
