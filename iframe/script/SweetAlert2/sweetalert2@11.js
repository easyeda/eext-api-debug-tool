...
!(function (e, t) {
	...
	const o = {},
		...
		R = (e, t) => {
			...
			switch (t) {
				...
				case 'radio':
					return (
						e.querySelector(`.${r.popup} > .${r.radio} input:checked`) || e.querySelector(`.${r.popup} > .${r.radio} input:first-child`)
					);
				case 'range':
				...
				setTimeout(() => {
					if ('MutationObserver' in window) {
						...
						new MutationObserver(() => {
							...
							const e =
								n.offsetWidth +
								((i = n), parseInt(window.getComputedStyle(i).marginLeft) + parseInt(window.getComputedStyle(i).marginRight));
							var i;
							const s = C();
			...
			qe(0, t),
				...
				((e, t) => {
					...
					if (t.icon && -1 === Object.keys(a).indexOf(t.icon))
						return d(`Unknown icon! Expected "success", "error", "warning", "info" or "question", got "${t.icon}"`), void Z(o);
					X(o),
						Le(o, t),
						Be(o, t),
	...
	const ht = (e) => {
		...
		gt = (e) =>
			void 0 === e ? { isConfirmed: !1, isDenied: !1, isDismissed: !0 } : Object.assign({ isConfirmed: !1, isDenied: !1, isDismissed: !1 }, e),
		ft = (e, t, n) => {
			var i;
			const s = y(),
				r = ne(t);
	...
	function Ft(e) {
		...
		o && (o.setAttribute('aria-invalid', 'true'), o.setAttribute('aria-describedby', r['validation-message']), F(o), z(o, r.inputerror));
	}
	function Ut() {
	...
	function sn() {
		...
		const t = he.domCache.get(this),
			n = he.innerParams.get(this);
		n
			? (t.popup && o.swalCloseEventFinishedCallback && (o.swalCloseEventFinishedCallback(), delete o.swalCloseEventFinishedCallback),
	...
	const kn = ['swal-title', 'swal-html', 'swal-footer'],
		...
		In = (e, t) => {
			ne(t)
				? ((e.style.overflowY = 'hidden'), t.addEventListener('animationend', Hn), t.addEventListener('transitionend', Hn))
	...
	var qn = (e, t) =>
			/^[a-zA-Z0-9.+_'-]+@[a-zA-Z0-9.-]+\.[a-zA-Z0-9-]+$/.test(e) ? Promise.resolve() : Promise.resolve(t || 'Invalid email address'),
		Nn = (e, t) =>
	...
	class Un {
		constructor(...t) {
			if ((n(this, Fn, Promise.resolve({ isConfirmed: !1, isDenied: !1, isDismissed: !0 })), 'undefined' == typeof window)) return;
			Rn = this;
			const o = Object.freeze(this.constructor.argsToParams(t));
			var i, s, r;
			(this.params = o), (this.isAwaitingPromise = !1), (i = Fn), (s = this), (r = this._main(Rn.params)), i.set(e(i, s), r);
		}
		_main(e, t = {}) {
