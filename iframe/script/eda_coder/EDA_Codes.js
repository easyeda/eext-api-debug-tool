edcode = [
	...
	},
	{
		...
		'description': '多个单页 PDF（将会输出包含所有分解图层 PDF 文件的压缩包）',
		'parameters': [],
		'isEnumMember': true,
		'enumType': 'eda.epcb_PdfOutputMethod',
	},
	{
		...
		'description': '单个单页 PDF（将会输出包含每层一个 PDF 文件的压缩包）',
		'parameters': [],
		'isEnumMember': true,
		'enumType': 'eda.epcb_PdfOutputMethod',
	},
