edcode = [
	{
		...
		'description': '控制台输出',
		'returns': '没有返回值',
		'parameters': [{ 'name': 'info', 'description': '要输出的内容' }],
	},
	{
	...
	},
	{
		...
		'returns': '分屏 ID',
		'parameters': [{ 'name': 'tabId', 'description': '标签页 ID' }],
	},
	{
		'methodPath': 'eda.dmt_EditorControl.getTabsBySplitScreenId',
		'description': '获取指定分屏 ID 下的所有标签页',
		'returns': '标签页列表',
		'parameters': [{ 'name': 'splitScreenId', 'description': '分屏 ID' }],
	},
	{
	...
	},
	{
		...
		'parameters': [{ 'name': 'tabId', 'description': '标签页 ID，如若未传入，则获取最后输入焦点的画布' }],
	},
	{
	...
	},
	{
		...
		'returns': '缩放到的区域数据，`false` 表示画布不支持该缩放操作或 `tabId` 不存在',
		'parameters': [{ 'name': 'tabId', 'description': '标签页 ID，如若未传入，则为最后输入焦点的画布' }],
	},
	{
	...
	},
	{
		...
		'returns': '文件夹 UUID 数组',
		'parameters': [{ 'name': 'teamUuid', 'description': '团队 UUID' }],
	},
	{
	...
	},
	{
		...
		'parameters': [{ 'name': 'boardName', 'description': '所属板子名称，如若不指定则为游离 PCB' }],
	},
	{
	...
	},
	{
		...
		'parameters': [{ 'name': 'pcbUuid', 'description': 'PCB UUID' }],
	},
	{
	...
	},
	{
		...
		'description': '打开工程',
		'returns': '是否成功打开工程',
		'parameters': [{ 'name': 'projectUuid', 'description': '工程 UUID' }],
	},
	{
	...
	},
	{
		...
		'parameters': [{ 'name': 'boardName', 'description': '所属板子名称，如若不指定则为游离原理图' }],
	},
	{
		'methodPath': 'eda.dmt_Schematic.createSchematicPage',
		'description': '创建原理图图页',
		'returns': '原理图图页 UUID，如若为 `undefined` 则创建失败',
		'parameters': [{ 'name': 'schematicUuid', 'description': '所属原理图 UUID' }],
	},
	{
	...
	},
	{
		...
		'description': '切换到工作区',
		'returns': '切换操作是否成功',
		'parameters': [{ 'name': 'workspaceUuid', 'description': '工作区 UUID，如若不指定，则将切换到个人工作区' }],
	},
	{
	...
	},
	{
		...
		'description': '添加多边形数据',
		'returns': '复杂多边形对象',
		'parameters': [{ 'name': 'complexPolygon', 'description': '复杂多边形数据' }],
	},
	{
	...
	},
	{
		...
		'parameters': [{ 'name': 'includeVias', 'description': '是否包含导线两端的过孔' }],
	},
	{
		'methodPath': 'eda.ipcb_PrimitiveArc.getEntireTrack',
		'description': '获取整段导线',
	...
	},
	{
		...
		'returns': '尺寸标注图元对象',
		'parameters': [{ 'name': 'dimensionType', 'description': '尺寸标注类型' }],
	},
	{
		'methodPath': 'eda.ipcb_PrimitiveDimension.setState_CoordinateSet',
		'description': '设置属性状态：坐标集',
		'returns': '尺寸标注图元对象',
		'parameters': [{ 'name': 'coordinateSet', 'description': '坐标集' }],
	},
	{
	...
	},
	{
		...
		'returns': '尺寸标注图元对象',
		'parameters': [{ 'name': 'unit', 'description': '单位' }],
	},
	{
	...
	},
	{
		...
		'returns': '尺寸标注图元对象',
		'parameters': [{ 'name': 'precision', 'description': '精度' }],
	},
	{
	...
	},
	{
		...
		'returns': '填充图元对象',
		'parameters': [{ 'name': 'complexPolygon', 'description': '复杂多边形' }],
	},
	{
	...
	},
	{
		...
		'returns': '填充图元对象',
		'parameters': [{ 'name': 'fillMode', 'description': '填充模式' }],
	},
	{
	...
	},
	{
		...
		'returns': '图像图元对象',
		'parameters': [{ 'name': 'x', 'description': 'BBox 左上点坐标 X' }],
	},
	{
		'methodPath': 'eda.ipcb_PrimitiveImage.setState_Y',
		'description': '设置属性状态：BBox 左上点坐标 Y',
		'returns': '图像图元对象',
		'parameters': [{ 'name': 'y', 'description': 'BBox 左上点坐标 Y' }],
	},
	{
	...
	},
	{
		...
		'returns': '图像图元对象',
		'parameters': [{ 'name': 'width', 'description': '宽' }],
	},
	{
		'methodPath': 'eda.ipcb_PrimitiveImage.setState_Height',
		'description': '设置属性状态：高',
		'returns': '图像图元对象',
		'parameters': [{ 'name': 'height', 'description': '高' }],
	},
	{
	...
	},
	{
		...
		'returns': '图像图元对象',
		'parameters': [{ 'name': 'horizonMirror', 'description': '是否水平镜像' }],
	},
	{
	...
	},
	{
		...
		'description': '设置属性状态：是否水平镜像',
		'returns': '二进制内嵌对象图元对象',
		'parameters': [{ 'name': 'mirror', 'description': '是否水平镜像' }],
	},
	{
		'methodPath': 'eda.ipcb_PrimitiveObject.setState_FileName',
		'description': '设置属性状态：文件名',
		'returns': '二进制内嵌对象图元对象',
		'parameters': [{ 'name': 'fileName', 'description': '文件名' }],
	},
	{
	...
	},
	{
		...
		'returns': '焊盘图元对象',
		'parameters': [{ 'name': 'pad', 'description': '焊盘外形' }],
	},
	{
	...
	},
	{
		...
		'returns': '折线图元对象',
		'parameters': [{ 'name': 'polygon', 'description': '单多边形' }],
	},
	{
	...
	},
	{
		...
		'returns': '区域图元对象',
		'parameters': [{ 'name': 'ruleType', 'description': '区域规则类型' }],
	},
	{
		'methodPath': 'eda.ipcb_PrimitiveRegion.setState_RegionName',
		'description': '设置属性状态：区域名称',
		'returns': '区域图元对象',
		'parameters': [{ 'name': 'regionName', 'description': '区域名称' }],
	},
	{
	...
	},
	{
		...
		'returns': '文本图元对象',
		'parameters': [{ 'name': 'text', 'description': '文本内容' }],
	},
	{
	...
	},
	{
		...
		'returns': '圆弧图元对象',
		'parameters': [{ 'name': 'lineType', 'description': '线型' }],
	},
	{
	...
	},
	{
		...
		'returns': '圆图元对象',
		'parameters': [{ 'name': 'fillStyle', 'description': '填充样式' }],
	},
	{
	...
	},
	{
		...
		'returns': '器件图元对象',
		'parameters': [{ 'name': 'addIntoPcb', 'description': '是否转到 PCB' }],
	},
	{
	...
	},
	{
		...
		'returns': '引脚图元对象',
		'parameters': [{ 'name': 'pinNumber', 'description': '引脚编号' }],
	},
	{
		'methodPath': 'eda.isch_PrimitivePin.setState_PinName',
		'description': '设置属性状态：引脚名称',
		'returns': '引脚图元对象',
		'parameters': [{ 'name': 'pinName', 'description': '引脚名称' }],
	},
	{
	...
	},
	{
		...
		'returns': '多边形图元对象',
		'parameters': [{ 'name': 'line', 'description': '坐标组' }],
	},
	{
	...
	},
	{
		...
		'returns': '矩形图元对象',
		'parameters': [{ 'name': 'cornerRadius', 'description': '圆角半径' }],
	},
	{
	...
	},
	{
		...
		'returns': '矩形图元对象',
		'parameters': [{ 'name': 'color', 'description': '边框颜色' }],
	},
	{
	...
	},
	{
		...
		'description': '设置属性状态：文本内容',
		'returns': '文本图元对象',
		'parameters': [{ 'name': 'content', 'description': '文本内容' }],
	},
	{
	...
	},
	{
		...
		'returns': '导线图元对象',
		'parameters': [{ 'name': 'color', 'description': '导线颜色' }],
	},
	{
	...
	},
	{
		...
		'returns': '两级分类的名称',
		'parameters': [{ 'name': 'classificationIndex', 'description': '分类索引' }],
	},
	{
	...
	},
	{
		...
		'parameters': [{ 'name': 'uuid', 'description': '原理图 UUID，默认为关联在同一个 Board 下的原理图' }],
	},
	{
		'methodPath': 'eda.pcb_Document.importAutoRouteJsonFile',
		'description': '导入自动布线文件（JSON）',
		'returns': '导入操作是否成功',
		'parameters': [{ 'name': 'autoRouteFile', 'description': '欲导入的 JSON 文件' }],
	},
	{
		'methodPath': 'eda.pcb_Document.importAutoLayoutJsonFile',
		'description': '导入自动布局文件（JSON）',
		'returns': '导入操作是否成功',
		'parameters': [{ 'name': 'autoLayoutFile', 'description': '欲导入的 JSON 文件' }],
	},
	{
	...
	},
	{
		...
		'parameters': [{ 'name': 'configurationName', 'description': '配置名称' }],
	},
	{
		'methodPath': 'eda.pcb_Drc.getAllRuleConfigurations',
		'description': '获取所有设计规则配置',
		'returns': '所有设计规则配置',
		'parameters': [{ 'name': 'includeSystem', 'description': '是否获取系统设计规则配置' }],
	},
	{
	...
	},
	{
		...
		'description': '覆写网络规则',
		'returns': '覆写是否成功',
		'parameters': [{ 'name': 'netRules', 'description': '网络规则' }],
	},
	{
	...
	},
	{
		...
		'returns': '覆写是否成功',
		'parameters': [{ 'name': 'netByNetRules', 'description': '网络-网络规则' }],
	},
	{
	...
	},
	{
		...
		'description': '覆写区域规则',
		'returns': '覆写是否成功',
		'parameters': [{ 'name': 'regionRules', 'description': '区域规则' }],
	},
	{
	...
	},
	{
		...
		'description': '删除网络类',
		'returns': '操作是否成功',
		'parameters': [{ 'name': 'netClassName', 'description': '网络类名称' }],
	},
	{
	...
	},
	{
		...
		'description': '删除差分对',
		'returns': '操作是否成功',
		'parameters': [{ 'name': 'differentialPairName', 'description': '差分对名称' }],
	},
	{
	...
	},
	{
		...
		'description': '删除等长网络组',
		'returns': '操作是否成功',
		'parameters': [{ 'name': 'equalLengthNetGroupName', 'description': '等长网络组名称' }],
	},
	{
	...
	},
	{
		...
		'description': '删除焊盘对组',
		'returns': '操作是否成功',
		'parameters': [{ 'name': 'padPairGroupName', 'description': '焊盘对组名称' }],
	},
	{
	...
	},
	{
		...
		'description': '移除事件监听',
		'returns': '是否移除指定事件监听',
		'parameters': [{ 'name': 'id', 'description': '事件 ID' }],
	},
	{
	...
	},
	{
		...
		'description': '锁定层',
		'returns': '操作是否成功',
		'parameters': [{ 'name': 'layer', 'description': '层，如若不指定任何层则默认为所有层' }],
	},
	{
	...
	},
	{
		...
		'description': '设置铜箔层数',
		'returns': '操作是否成功',
		'parameters': [{ 'name': 'numberOfLayers', 'description': '层数' }],
	},
	{
		'methodPath': 'eda.pcb_Layer.setLayerColorConfiguration',
		'description': '设置层颜色配置',
		'returns': '操作是否成功',
		'parameters': [{ 'name': 'colorConfiguration', 'description': '颜色配置' }],
	},
	{
		'methodPath': 'eda.pcb_Layer.setInactiveLayerTransparency',
		'description': '设置非激活层透明度',
		'returns': '操作是否成功',
		'parameters': [{ 'name': 'transparency', 'description': '透明度，范围 `0-100`' }],
	},
	{
		'methodPath': 'eda.pcb_Layer.setPcbType',
		'description': '设置 PCB 类型',
		'returns': '操作是否成功',
		'parameters': [{ 'name': 'pcbType', 'description': 'PCB 类型' }],
	},
	{
	...
	},
	{
		...
		'returns': '是否设置成功',
		'parameters': [{ 'name': 'displayMode', 'description': '展示模式' }],
	},
	{
	...
	},
	{
		...
		'returns': 'BOM 模板文件',
		'parameters': [{ 'name': 'template', 'description': 'BOM 模板名称' }],
	},
	{
	...
	},
	{
		...
		'parameters': [{ 'name': 'polygon', 'description': '单多边形数据' }],
	},
	{
	...
	},
	{
		...
		'description': '拆分单多边形',
		'returns': '单多边形数组',
		'parameters': [{ 'name': 'complexPolygons', 'description': '复杂多边形' }],
	},
	{
	...
	},
	{
		...
		'description': '获取网表',
		'returns': '网表数据',
		'parameters': [{ 'name': 'type', 'description': '网表格式' }],
	},
	{
	...
	},
	{
		...
		'parameters': [{ 'name': 'primitiveIds', 'description': '图元 ID 数组或图元对象数组' }],
	},
	{
	...
	},
	{
		...
		'description': '删除圆弧线',
		'returns': '删除操作是否成功',
		'parameters': [{ 'name': 'primitiveIds', 'description': '圆弧线的图元 ID 或圆弧线图元对象' }],
	},
	{
	...
	},
	{
		...
		'parameters': [{ 'name': 'primitiveIds', 'description': '圆弧线的图元 ID，可以为字符串或字符串数组，如若为数组，则返回的也是数组' }],
	},
	{
		'methodPath': 'eda.pcb_PrimitiveArc.get',
		'description': '获取圆弧线',
	...
	},
	{
		...
		'description': '删除器件',
		'returns': '删除操作是否成功',
		'parameters': [{ 'name': 'primitiveIds', 'description': '器件的图元 ID 或器件图元对象' }],
	},
	{
	...
	},
	{
		...
		'parameters': [{ 'name': 'primitiveIds', 'description': '器件的图元 ID，可以为字符串或字符串数组，如若为数组，则返回的也是数组' }],
	},
	{
		'methodPath': 'eda.pcb_PrimitiveComponent.get',
		'description': '获取器件',
	...
	},
	{
		...
		'description': '获取器件关联的所有焊盘',
		'returns': '器件焊盘图元数组',
		'parameters': [{ 'name': 'primitiveId', 'description': '器件图元 ID' }],
	},
	{
	...
	},
	{
		...
		'description': '删除尺寸标注',
		'returns': '删除操作是否成功',
		'parameters': [{ 'name': 'primitiveIds', 'description': '尺寸标注的图元 ID 或尺寸标注图元对象' }],
	},
	{
	...
	},
	{
		...
		'parameters': [{ 'name': 'primitiveIds', 'description': '尺寸标注的图元 ID，可以为字符串或字符串数组，如若为数组，则返回的也是数组' }],
	},
	{
		'methodPath': 'eda.pcb_PrimitiveDimension.get',
		'description': '获取尺寸标注',
	...
	},
	{
		...
		'description': '删除填充',
		'returns': '删除操作是否成功',
		'parameters': [{ 'name': 'primitiveIds', 'description': '填充的图元 ID 或填充图元对象' }],
	},
	{
	...
	},
	{
		...
		'parameters': [{ 'name': 'primitiveIds', 'description': '填充的图元 ID，可以为字符串或字符串数组，如若为数组，则返回的也是数组' }],
	},
	{
		'methodPath': 'eda.pcb_PrimitiveFill.get',
		'description': '获取填充',
		'returns': '填充图元对象，空数组表示获取失败',
		'parameters': [{ 'name': 'primitiveIds', 'description': '填充的图元 ID，可��为字符串或字符串数组，如若为数组，则返回的也是数组' }],
	},
	{
	...
	},
	{
		...
		'description': '删除图像',
		'returns': '删除操作是否成功',
		'parameters': [{ 'name': 'primitiveIds', 'description': '图像的图元 ID 或图像图元对象' }],
	},
	{
	...
	},
	{
		...
		'parameters': [{ 'name': 'primitiveIds', 'description': '图像的图元 ID，可以为字符串或字符串数组，如若为数组，则返回的也是数组' }],
	},
	{
		'methodPath': 'eda.pcb_PrimitiveImage.get',
		'description': '获取图像',
	...
	},
	{
		...
		'description': '删除直线',
		'returns': '删除操作是否成功',
		'parameters': [{ 'name': 'primitiveIds', 'description': '直线的图元 ID 或直线图元对象' }],
	},
	{
	...
	},
	{
		...
		'parameters': [{ 'name': 'primitiveIds', 'description': '直线的图元 ID，可以为字符串或字符串数组，如若为数组，则返回的也是数组' }],
	},
	{
		'methodPath': 'eda.pcb_PrimitiveLine.get',
		'description': '获取直线',
	...
	},
	{
		...
		'returns': '删除操作是否成功',
		'parameters': [{ 'name': 'primitiveIds', 'description': '二进制内嵌对象的图元 ID 或二进制内嵌对象图元对象' }],
	},
	{
	...
	},
	{
		...
		'parameters': [{ 'name': 'primitiveIds', 'description': '二进制内嵌对象的图元 ID，可以为字符串或字符串数组，如若为数组，则返回的也是数组' }],
	},
	{
		'methodPath': 'eda.pcb_PrimitiveObject.get',
		'description': '获取二进制内嵌对象',
	...
	},
	{
		...
		'description': '删除焊盘',
		'returns': '删除操作是否成功',
		'parameters': [{ 'name': 'primitiveIds', 'description': '焊盘的图元 ID 或焊盘图元对象' }],
	},
	{
	...
	},
	{
		...
		'parameters': [{ 'name': 'primitiveIds', 'description': '焊盘的图元 ID，可以为字符串或字符串数组，如若为数组，则返回的也是数组' }],
	},
	{
		'methodPath': 'eda.pcb_PrimitivePad.get',
		'description': '获取焊盘',
	...
	},
	{
		...
		'description': '删除折线',
		'returns': '删除操作是否成功',
		'parameters': [{ 'name': 'primitiveIds', 'description': '折线的图元 ID 或折线图元对象' }],
	},
	{
	...
	},
	{
		...
		'parameters': [{ 'name': 'primitiveIds', 'description': '折线的图元 ID，可以为字符串或字符串数组，如若为数组，则返回的也是数组' }],
	},
	{
		'methodPath': 'eda.pcb_PrimitivePolyline.get',
		'description': '获取折线',
	...
	},
	{
		...
		'description': '删除覆铜边框',
		'returns': '删除操作是否成功',
		'parameters': [{ 'name': 'primitiveIds', 'description': '覆铜边框的图元 ID 或覆铜边框图元对象' }],
	},
	{
	...
	},
	{
		...
		'parameters': [{ 'name': 'primitiveIds', 'description': '覆铜边框的图元 ID，可以为字符串或字符串数组，如若为数组，则返回的也是数组' }],
	},
	{
		'methodPath': 'eda.pcb_PrimitivePour.get',
		'description': '获取覆铜边框',
	...
	},
	{
		...
		'description': '删除区域',
		'returns': '删除操作是否成功',
		'parameters': [{ 'name': 'primitiveIds', 'description': '区域的图元 ID 或区域图元对象' }],
	},
	{
	...
	},
	{
		...
		'parameters': [{ 'name': 'primitiveIds', 'description': '区域的图元 ID，可以为字符串或字符串数组，如若为数组，则返回的也是数组' }],
	},
	{
		'methodPath': 'eda.pcb_PrimitiveRegion.get',
		'description': '获取区域',
	...
	},
	{
		...
		'description': '删除过孔',
		'returns': '删除操作是否成功',
		'parameters': [{ 'name': 'primitiveIds', 'description': '过孔的图元 ID 或过孔图元对象' }],
	},
	{
	...
	},
	{
		...
		'parameters': [{ 'name': 'primitiveIds', 'description': '过孔的图元 ID，可以为字符串或字符串数组，如若为数组，则返回的也是数组' }],
	},
	{
		'methodPath': 'eda.pcb_PrimitiveVia.get',
		'description': '获取过孔',
	...
	},
	{
		...
		'returns': '操作是否成功',
		'parameters': [{ 'name': 'primitiveIds', 'description': '图元 ID' }],
	},
	{
	...
	},
	{
		...
		'returns': '图元类型',
		'parameters': [{ 'name': 'id', 'description': '图元 ID' }],
	},
	{
	...
	},
	{
		...
		'description': '删除圆弧',
		'returns': '删除操作是否成功',
		'parameters': [{ 'name': 'primitiveIds', 'description': '圆弧的图元 ID 或圆弧图元对象' }],
	},
	{
	...
	},
	{
		...
		'parameters': [{ 'name': 'primitiveIds', 'description': '圆弧的图元 ID，可以为字符串或字符串数组，如若为数组，则返回的也是数组' }],
	},
	{
		'methodPath': 'eda.sch_PrimitiveArc.get',
		'description': '获取圆弧',
	...
	},
	{
		...
		'description': '删除总线',
		'returns': '删除操作是否成功',
		'parameters': [{ 'name': 'primitiveIds', 'description': '总线的图元 ID 或总线图元对象' }],
	},
	{
	...
	},
	{
		...
		'parameters': [{ 'name': 'primitiveIds', 'description': '总线的图元 ID，可以为字符串或字符串数组，如若为数组，则返回的也是数组' }],
	},
	{
		'methodPath': 'eda.sch_PrimitiveBus.get',
		'description': '获取总线',
	...
	},
	{
		...
		'description': '删除圆',
		'returns': '删除操作是否成功',
		'parameters': [{ 'name': 'primitiveIds', 'description': '圆的图元 ID 或圆图元对象' }],
	},
	{
	...
	},
	{
		...
		'parameters': [{ 'name': 'primitiveIds', 'description': '圆的图元 ID，可以为字符串或字符串数组，如若为数组，则返回的也是数组' }],
	},
	{
		'methodPath': 'eda.sch_PrimitiveCircle.get',
		'description': '获取圆',
	...
	},
	{
		...
		'returns': '操作是否成功',
		'parameters': [{ 'name': 'component', 'description': '关联库器件' }],
	},
	{
	...
	},
	{
		...
		'description': '删除引脚',
		'returns': '删除操作是否成功',
		'parameters': [{ 'name': 'primitiveIds', 'description': '引脚的图元 ID 或引脚图元对象' }],
	},
	{
	...
	},
	{
		...
		'parameters': [{ 'name': 'primitiveIds', 'description': '引脚的图元 ID，可以为字符串或字符串数组，如若为数组，则返回的也是数组' }],
	},
	{
		'methodPath': 'eda.sch_PrimitivePin.get',
		'description': '获取引脚',
	...
	},
	{
		...
		'description': '删除多边形',
		'returns': '删除操作是否成功',
		'parameters': [{ 'name': 'primitiveIds', 'description': '多边形的图元 ID 或多边形图元对象' }],
	},
	{
	...
	},
	{
		...
		'parameters': [{ 'name': 'primitiveIds', 'description': '多边形的图元 ID，可以为字符串或字符串数组，如若为数组，则返回的也是数组' }],
	},
	{
		'methodPath': 'eda.sch_PrimitivePolygon.get',
		'description': '获取多边形',
	...
	},
	{
		...
		'description': '删除矩形',
		'returns': '删除操作是否成功',
		'parameters': [{ 'name': 'primitiveIds', 'description': '矩形的图元 ID 或矩形图元对象' }],
	},
	{
	...
	},
	{
		...
		'parameters': [{ 'name': 'primitiveIds', 'description': '矩形的图元 ID，可以为字符串或字符串数组，如若为数组，则返回的也是数组' }],
	},
	{
		'methodPath': 'eda.sch_PrimitiveRectangle.get',
		'description': '获取矩形',
	...
	},
	{
		...
		'description': '删除文本',
		'returns': '删除操作是否成功',
		'parameters': [{ 'name': 'primitiveIds', 'description': '文本的图元 ID 或文本图元对象' }],
	},
	{
	...
	},
	{
		...
		'parameters': [{ 'name': 'primitiveIds', 'description': '文本的图元 ID，可以为字符串或字符串数组，如若为数组，则返回的也是数组' }],
	},
	{
		'methodPath': 'eda.sch_PrimitiveText.get',
		'description': '获取文本',
	...
	},
	{
		...
		'description': '删除导线',
		'returns': '删除操作是否成功',
		'parameters': [{ 'name': 'primitiveIds', 'description': '导线的图元 ID 或导线图元对象' }],
	},
	{
	...
	},
	{
		...
		'parameters': [{ 'name': 'primitiveIds', 'description': '导线的图元 ID，可以为字符串或字符串数组，如若为数组，则返回的也是数组' }],
	},
	{
		'methodPath': 'eda.sch_PrimitiveWire.get',
		'description': '获取导线',
	...
	},
	{
		...
		'parameters': [{ 'name': 'status', 'description': '环境变量状态' }],
	},
	{
	...
	},
	{
		...
		'parameters': [{ 'name': 'source', 'description': '文档源码' }],
	},
	{
	...
	},
	{
		...
		'returns': 'File 格式文件',
		'parameters': [{ 'name': 'uri', 'description': '文件路径' }],
	},
	{
	...
	},
	{
		...
		'returns': 'File 格式文件',
		'parameters': [{ 'name': 'uri', 'description': '文件资源定位符，需要包含完整的文件名称的绝对路径' }],
	},
	{
	...
	},
	{
		...
		'parameters': [{ 'name': 'headerMenus', 'description': '顶部菜单数据' }],
	},
	{
	...
	},
	{
		...
		'returns': '是否受支持',
		'parameters': [{ 'name': 'language', 'description': '语言' }],
	},
	{
	...
	},
	{
		...
		'returns': '操作是否成功',
		'parameters': [{ 'name': 'id', 'description': '内联框架窗口 ID，如若传入 `undefined`，将关闭由本扩展打开的所有内联框架窗口' }],
	},
	{
		'methodPath': 'eda.sys_IFrame.hideIFrame',
		'description': '隐藏内联框架窗口',
		'returns': '操作是否成功',
		'parameters': [{ 'name': 'id', 'description': '内联框架窗口 ID' }],
	},
	{
	...
	},
	{
		...
		'description': '导出日志',
		'parameters': [{ 'name': 'types', 'description': '日志类型' }],
	},
	{
		'methodPath': 'eda.sys_Log.sort',
		'description': '筛选并获取日志条目',
		'returns': '符合筛选条件的日志条目数组',
		'parameters': [{ 'name': 'types', 'description': '日志类型数组，可以同时指定多种日志类型，如若不指定则为全部类型' }],
	},
	{
	...
	},
	{
		...
		'parameters': [{ 'name': 'tip', 'description': '提示内容，如若传入，则仅当当前提示为指定内容时才移除' }],
	},
	{
	...
	},
	{
		...
		'description': '打开左侧面板',
		'parameters': [{ 'name': 'tab', 'description': '标签页，如若不指定则不切换标签页' }],
	},
	{
	...
	},
	{
		...
		'parameters': [{ 'name': 'state', 'description': '是否锁定，如若不指定则反置当前状态' }],
	},
	{
	...
	},
	{
		...
		'description': '反注册快捷键',
		'returns': '反注册操作是否成功',
		'parameters': [{ 'name': 'shortcutKey', 'description': '快捷键，不区分传入的排列顺序，将自动排序并查询匹配的快捷键' }],
	},
	{
		'methodPath': 'eda.sys_ShortcutKey.getShortcutKeys',
		'description': '查询快捷键列表',
		'returns': '快捷键列表',
		'parameters': [{ 'name': 'includeSystem', 'description': '是否包含系统快捷键' }],
	},
	{
	...
	},
	{
		...
		'returns': '操作是否成功',
		'parameters': [{ 'name': 'configs', 'description': '扩展所有用户配置' }],
	},
	{
	...
	},
	{
		...
		'parameters': [{ 'name': 'key', 'description': '配置项' }],
	},
	{
	...
	},
	{
		...
		'returns': '定时器是否清除成功',
		'parameters': [{ 'name': 'id', 'description': '定时器 ID' }],
	},
	{
	...
	},
	{
		...
		'description': '移除事件监听',
		'parameters': [{ 'name': 'removableObject', 'description': '窗口事件监听可移除对象' }],
	},
	{
	...
	},
	{
		...
		'returns': '参数值',
		'parameters': [{ 'name': 'key', 'description': '参数名' }],
	},
	{
