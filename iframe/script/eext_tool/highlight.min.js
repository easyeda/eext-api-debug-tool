...
var hljs = (function () {
		...
		ne = (t) => {
			...
			'undefined' != typeof window &&
				...
				Object.assign(t, {
					...
					highlightElement: y,
					highlightBlock: (e) => (
						q('10.7.0', 'highlightBlock will be removed entirely in v12.0'), q('10.7.0', 'Please use highlightElement now.'), y(e)
					),
					configure: (e) => {
						p = Y(p, e);
					},
	...
	var Ke = Object.freeze({
		...
		grmr_shell: (e) => ({
			...
			contains: [
				{ className: 'meta.prompt', begin: /^\s{0,3}[/~\w\d[\]()@-]*[>%$#][ ]?/, starts: { end: /[^\\](?=\s*$)/, subLanguage: 'bash' } },
			],
		}),
		grmr_sql: (e) => {
			const n = e.regex,
