		...
		var _ = [
						...
						(i.prototype.toString = function () {
							...
							return (
								this.is_empty()
									...
									: ((t = this.__parent.get_indent_string(this.__indent_count, this.__alignment_count)),
										(t += this.__items.join(''))),
								t
							);
						}),
					...
					(_.prototype.tokenize = function () {
						...
						for (var t, e = new s(o.START, ''), n = null, _ = [], i = new r(); e.type !== o.EOF; ) {
							...
							i.isEmpty() || ((t.comments_before = i), (i = new r())),
								...
								this._is_opening(t)
									? (_.push(n), (n = t))
									: n && this._is_closing(t, n) && (((t.opened = n).closed = t), (n = _.pop()), (t.parent = n)),
								((t.previous = e).next = t),
								this.__tokens.add(t),
								(e = t);
						}
				...
				function (t, e, n) {
					...
					((i.prototype = new _()).__set_whitespace_patterns = function (t, e) {
						...
						(i.prototype.__split = function (t, e) {
							for (var n = (t.lastIndex = 0), _ = [], i = t.exec(e); i; )
								_.push(e.substring(n, i.index)), (n = i.index + i[0].length), (i = t.exec(e));
				...
				function (t) {
					...
					(e.prototype.read = function () {
						...
						return (
							(this._starting_pattern && !t) || (t += this._input.read(this._match_pattern, this._until_pattern, this._until_after)), t
						);
					}),
				...
				function (t) {
					...
					(e.prototype.get_directives = function (t) {
						...
						for (var e = {}, n = ((this.__directive_pattern.lastIndex = 0), this.__directive_pattern.exec(t)); n; )
					...
					((s.prototype = new _())._create = function () {
						...
						(s.prototype.__set_templated_pattern = function () {
							...
							this._disabled.php || t.push(this.__patterns.php._starting_pattern.source),
								...
								this._disabled.angular || t.push(this.__patterns.handlebars._starting_pattern.source),
									...
									: '{' === n &&
										...
										this._disabled.smarty ||
											(this._disabled.django &&
												this._disabled.handlebars &&
												(e =
													(e = (e = e || this.__patterns.smarty_comment.read()) || this.__patterns.smarty_literal.read()) ||
				...
				function (t, e, n) {
						...
						(p.prototype.print_preserved_newlines = function (t) {
							...
							t.type !== u.TEXT && t.previous.type !== u.TEXT && (e = t.newlines ? 1 : 0),
								this.preserve_newlines &&
									(e = t.newlines < this.max_preserve_newlines + 1 ? t.newlines : this.max_preserve_newlines + 1);
					...
					(d.prototype.get_parser_token = function () {
						...
						(g.prototype._handle_control_flow_open = function (t, e) {
						...
						(g.prototype._handle_control_flow_close = function (t, e) {
							var n = { text: e.text, type: e.type };
							return (
								t.deindent(),
								e.newlines ? t.print_preserved_newlines(e) : t.set_space_before_token(e.newlines || '' !== e.whitespace_before, !0),
						...
						(g.prototype._handle_inside_tag = function (t, e, n, _) {
								...
								n.is_unformatted
									...
									: '{' === n.tag_start_char && e.type === u.TEXT
										...
										: (e.type === u.ATTRIBUTE
												...
												: (e.type === u.EQUALS || (e.type === u.VALUE && e.previous.type === u.EQUALS)) &&
										...
										('javascript' === n.custom_beautifier_name && 'function' == typeof this._js_beautify
											...
											: 'css' === n.custom_beautifier_name && 'function' == typeof this._css_beautify
												...
												: 'html' === n.custom_beautifier_name &&
													(i = function (t, e) {
														return new g(t, e, _._js_beautify, _._css_beautify).beautify();
													}),
								...
								(s =
									...
									(i
										? (((n = function () {
											...
											i(r + s, new n()))
										: r +
											(s = (i = e.whitespace_before) ? s.replace(new RegExp('\n(' + i + ')?', 'g'), '\n') : s).replace(
												/\n/g,
												'\n' + r,
											))),
									a && (s = s ? a + s + '\n' + o : a + o),
						...
						(g.prototype._handle_tag_open = function (t, e, n, _, i) {
							...
							if (
								((!n.is_unformatted && !n.is_content_unformatted) || n.is_empty_element || e.type !== u.TAG_OPEN || s.is_start_tag
									? (t.traverse_whitespace(e),
										this._set_tag_position(t, e, s, n, _),
								...
								for (
									var r, a = 0;
									(r = i.peek(a)).type === u.ATTRIBUTE && (s.attr_count += 1), (a += 1), r.type !== u.EOF && r.type !== u.TAG_CLOSE;
					...
					var f = function (t, e, n) {
							...
							(this.parent = e || null),
								...
								(this.tag_check = ''),
								n
									? ((this.tag_start_char = n.text[0]),
										(this.text = n.text),
										'<' === this.tag_start_char
											? ((_ = n.text.match(/^<([^\s>]*)/)), (this.tag_check = _ ? _[1] : ''))
											: ((_ = n.text.match(/^{{~?(?:[\^]|#\*?)?([^\s}]+)/)),
												(this.tag_check = _ ? _[1] : ''),
												(n.text.startsWith('{{#>') || n.text.startsWith('{{~#>')) &&
													'>' === this.tag_check[0] &&
													('>' === this.tag_check && null !== n.next
														? (this.tag_check = n.next.text.split(' ')[0])
														: (this.tag_check = n.text.split('>')[1]))),
										(this.tag_check = this.tag_check.toLowerCase()),
										n.type === u.COMMENT && (this.tag_complete = !0),
										(this.is_start_tag = '/' !== this.tag_check.charAt(0)),
										(this.tag_name = this.is_start_tag ? this.tag_check : this.tag_check.substr(1)),
										(this.is_end_tag = !this.is_start_tag || (n.closed && '/>' === n.closed.text)),
										(e = 2),
										'{' === this.tag_start_char && 3 <= this.text.length && '~' === this.text.charAt(2) && (e = 3),
										(this.is_end_tag =
											this.is_end_tag ||
											('{' === this.tag_start_char &&
												(!t.indent_handlebars || this.text.length < 3 || /[^#\^]/.test(this.text.charAt(e))))))
									: (this.tag_complete = !0);
						},
						o =
							((g.prototype._get_tag_open_token = function (t) {
								t = new f(this._options, this._tag_stack.get_parser_token(), t);
								return (
							...
							(g.prototype._set_tag_position = function (t, e, n, _, i) {
								n.is_empty_element ||
									(n.is_end_tag
											...
											? ((e = !1),
												(e =
													...
													(!n.is_inline_element &&
														...
														!(i.type === u.TAG_CLOSE && n.start_tag_token === _) &&
														'TK_CONTENT' !== i.type)),
				...
				function (t, e, n) {
					...
					((_.prototype = new i())._is_comment = function (t) {
						...
						(_.prototype._get_next_token = function (t, e) {
							...
							return null === n
								...
								: this._read_open_handlebars(n, e) ||
										...
										this._read_script_and_style(n, t) ||
								...
								'<' === t &&
									('!' === this._input.peek(1) &&
										((n = this.__patterns.comment.read())
											? (_ = h.get_directives(n)) && 'start' === _.ignore && (n += h.readIgnored(this._input))
								...
								'<' === t &&
									(n =
										'!' !== (t = this._input.peek(1)) && '?' !== t
											? n
											: (n = this.__patterns.conditional_comment.read()) || this.__patterns.processing.read()) &&
							...
							return (
								(e && e.type !== p.CONTROL_FLOW_OPEN) ||
									('<' === t &&
										...
										(_ = this._create_token(p.TAG_OPEN, n)))),
								_
							);
						}),
						(_.prototype._read_open_handlebars = function (t, e) {
							...
							return (
								(e && e.type !== p.CONTROL_FLOW_OPEN) ||
									((this._options.templating.includes('angular') || this._options.indent_handlebars) &&
										'{' === t &&
										'{' === this._input.peek(1) &&
										(_ =
											this._options.indent_handlebars && '!' === this._input.peek(2)
						...
						(_.prototype._read_control_flows = function (t, e) {
							var n = '',
								_ = null;
							if (!this._options.templating.includes('angular')) return _;
							if ('@' === t) {
								...
								'}' === t &&
									e &&
									e.type === p.CONTROL_FLOW_OPEN &&
									((n = this._input.next()), (_ = this._create_token(p.CONTROL_FLOW_CLOSE, n)));
							return _;
						}),
								...
								e &&
									...
									('<' === e.text[0] && ('>' === t || ('/' === t && '>' === this._input.peek(1)))
										...
										: '{' === e.text[0] &&
											'}' === t &&
											'}' === this._input.peek(1) &&
											(this._input.next(), this._input.next(), (_ = this._create_token(p.TAG_CLOSE, '}}')))),
								_
							);
						}),
							...
							return (
								n &&
									...
									('=' === t
										...
										: '"' === t || "'" === t
											? ((n = this._input.next()),
												(n += ('"' === t ? this.__patterns.double_quote : this.__patterns.single_quote).read()),
												(_ = this._create_token(p.VALUE, n)))
											: (t = this.__patterns.attribute.read()) &&
												(_ = e.type === p.EQUALS ? this._create_token(p.VALUE, t) : this._create_token(p.ATTRIBUTE, t))),
								_
							);
						}),
						(_.prototype._is_content_unformatted = function (t) {
							return (
								...
								(-1 !== this._options.content_unformatted.indexOf(t) || -1 !== this._options.unformatted.indexOf(t))
							);
						}),
						(_.prototype._read_raw_content = function (t, e, n) {
							...
							return (
								...
								_ ? this._create_token(p.TEXT, _) : null
							);
						}),
						(_.prototype._read_script_and_style = function (t, e) {
							if (e.type === p.TAG_CLOSE && '<' === e.opened.text[0] && '/' !== e.text[0]) {
								e = e.opened.text.substr(1).toLowerCase();
								if ('script' === e || 'style' === e) {
									t = this._read_comment_or_cdata(t);
									if (t) return (t.type = p.TEXT), t;
									t = this._input.readUntil(new RegExp('</' + e + '[\\n\\r\\t ]*?>', 'ig'));
									if (t) return this._create_token(p.TEXT, t);
								}
							}
							return null;
						}),
						(_.prototype._read_content_word = function (t, e) {
							...
							return (n =
								(n =
									this._options.unformatted_content_delimiter && t === this._options.unformatted_content_delimiter[0]
