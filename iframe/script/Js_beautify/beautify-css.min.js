		...
		var n = [
				...
				function (t, e, i) {
					...
					(_.prototype.eatString = function (t) {
						...
						(_.prototype.eatWhitespace = function (t) {
							for (var e = k.test(this._input.peek()), i = 0; k.test(this._input.peek()); )
								(this._ch = this._input.next()),
									t &&
										'\n' === this._ch &&
						...
						(_.prototype.beautify = function () {
							...
							for (
								...
								if ('/' === this._ch && '*' === this._input.peek()) {
									...
									f && 'start' === f.ignore && (d += v.readIgnored(this._input)),
										this.print_string(d),
									...
									f.match(/[ :]$/) &&
										...
										this.print_string(f),
										(this._output.space_before_token = !0)),
										0 === r && -1 !== f.indexOf(':') && ((o = !0), this.indent());
								} else if ('@' === this._ch)
									this.preserveSingleSpace(t),
										'{' === this._input.peek()
											? this.print_string(this._ch + this.eatString('}'))
											: (this.print_string(this._ch),
												(d = this._input.peekUntilAfter(/[: ,;{}()[\]\/='"]/g)).match(/[ :]$/) &&
												...
												0 === r && -1 !== d.indexOf(':')
													...
													: d in this.NESTED_AT_RULE
														? ((this._nestedLevel += 1), d in this.CONDITIONAL_GROUP_RULE && (p = !0))
														: 0 !== r || o || (a = !0));
								else if ('#' === this._ch && '{' === this._input.peek())
									...
									o && ((o = !1), this.outdent()),
										(a = !1),
										(h = p ? ((p = !1), this._indentLevel >= this._nestedLevel) : this._indentLevel >= this._nestedLevel - 1),
										...
										'expand' === this._options.brace_style
											...
											: ('(' === e ? (this._output.space_before_token = !1) : ',' !== e && this.indent(),
												this.print_string(this._ch)),
										this.eatWhitespace(!0),
										this._output.add_new_line();
								else if ('}' === this._ch)
									this.outdent(),
										...
										')' === this._input.peek() &&
											(this._output.trim(!0), 'expand' === this._options.brace_style && this._output.add_new_line(!0));
								else if (':' === this._ch) {
									...
									0 !== r
										? (this._input.lookBack(' ') && (this._output.space_before_token = !0),
											':' === this._input.peek()
												...
												: this.print_string(':'))
										: (this.print_string(':'),
											o || ((this._output.space_before_token = o = !0), this.eatWhitespace(!0), this.indent()));
								} else
									'"' === this._ch || "'" === this._ch
												...
												? this._input.lookBack('url')
													? (this.print_string(this._ch),
														...
														')' === this._ch || '"' === this._ch || "'" === this._ch
															? this._input.back()
															: this._ch &&
																(this.print_string(this._ch + this.eatString(')')), r && (r--, this.outdent())))
													: ((i = !1),
														this._input.lookBack('with') && (i = !0),
														this.preserveSingleSpace(t || i),
														this.print_string(this._ch),
														o && '$' === e && this._options.selector_separator_newline
												...
												: ')' === this._ch
													? (r && (r--, this.outdent()),
														u &&
															...
															((u = !1), this.outdent(), this._output.add_new_line()),
														this.print_string(this._ch))
													: ',' === this._ch
														? (this.print_string(this._ch),
															this.eatWhitespace(!0),
															!this._options.selector_separator_newline || (o && !u) || 0 !== r || a
																? (this._output.space_before_token = !0)
																: this._output.add_new_line())
														: ('>' !== this._ch && '+' !== this._ch && '~' !== this._ch) || o || 0 !== r
															? ']' === this._ch
																? this.print_string(this._ch)
																: '[' === this._ch
																	? (this.preserveSingleSpace(t), this.print_string(this._ch))
															...
															: this._options.space_around_combinator
																...
																: (this.print_string(this._ch),
																	this.eatWhitespace(),
																	this._ch && k.test(this._ch) && (this._ch = ''));
				...
				function (t, e, i) {
					...
					function _(t) {
						...
						for (var i = 0; i < e.length; i++) 'expand' !== e[i] ? (this.brace_style = 'collapse') : (this.brace_style = e[i]);
					}
