		...
		var n = [
				...
				function (t, e, i) {
					...
					(T.prototype.create_flags = function (t, e) {
						...
						(T.prototype.handle_whitespace_and_comments = function (t, e) {
							...
							if (t.comments_before)
								for (var u = t.comments_before.next(); u; )
									this.handle_whitespace_and_comments(u, e), this.handle_token(u, e), (u = t.comments_before.next());
							if (n) for (var _ = 0; _ < i; _ += 1) this.print_newline(0 < _, e);
								...
								(this._options.max_preserve_newlines &&
									...
									(i = this._options.max_preserve_newlines),
								this._options.preserve_newlines && 1 < i)
							) {
					...
					(T.prototype.allow_wrap_or_preserved_newline = function (t, e) {
						(e = void 0 !== e && e),
							this._output.just_added_newline() ||
								...
								(l(this._flags.last_token.text, h) || l(t.text, h)) &&
									((t = (l(this._flags.last_token.text, h) && l(this._options.operator_position, b)) || l(t.text, h)),
									(e = e && t)),
								e
									? this.print_newline(!1, !0)
									: this._options.wrap_line_length && !f(this._flags.last_token, A) && this._output.set_wrap_point());
					}),
						(T.prototype.print_newline = function (t, e) {
							if (
								...
								for (
									...
									!(this._flags.mode !== k || (this._flags.if_block && a(i, 'else')) || this._flags.do_block);
							...
							if ('[' === t.text) {
								...
								(n = w),
									!R(this._flags.mode) ||
										...
										this.print_newline(),
									l(this._flags.last_token.type, [p.START_EXPR, p.END_EXPR, p.WORD, p.OPERATOR, p.DOT]) ||
										(this._output.space_before_token = !0);
							} else
										...
										: l(this._flags.last_token.text, ['if', 'while', 'switch'])
											...
											: l(this._flags.last_word, ['await', 'async'])
												...
												: 'import' === this._flags.last_token.text && '' === t.whitespace_before
													? (this._output.space_before_token = !1)
													: (!l(this._flags.last_token.text, r) && 'catch' !== this._flags.last_token.text) ||
														(this._output.space_before_token = !0)
						...
						(T.prototype.handle_end_expr = function (t) {
							...
							this.handle_whitespace_and_comments(t),
								...
								this._options.space_in_paren &&
									(this._flags.last_token.type !== p.START_EXPR || this._options.space_in_empty_paren
										? (this._output.space_before_token = !0)
								...
								this._flags.do_while &&
									...
									((this._previous_flags.mode = v), (this._flags.do_block = !1), (this._flags.do_while = !1));
						}),
						(T.prototype.handle_start_block = function (t) {
								...
								i =
									('switch' === this._flags.last_word && this._flags.last_token.type === p.END_EXPR
										...
										: this._flags.case_body
											? this.set_mode(g)
											: i &&
												  ((l(i.text, [':', ',']) && l(e.type, [p.STRING, p.WORD, p.RESERVED])) ||
														(l(e.text, ['get', 'set', '...']) && l(i.type, [p.WORD, p.RESERVED])))
												? l(this._last_last_text, ['class', 'interface']) && !l(i.text, [':', ','])
													? this.set_mode(g)
													: this.set_mode(m)
												: (this._flags.last_token.type !== p.OPERATOR || '=>' !== this._flags.last_token.text) &&
													  (l(this._flags.last_token.type, [p.EQUALS, p.START_EXPR, p.COMMA, p.OPERATOR]) ||
							...
							('expand' === this._options.brace_style || ('none' === this._options.brace_style && t.newlines)) &&
							!this._flags.inline_frame
								...
								: (!R(this._previous_flags.mode) ||
									...
									this._flags.last_token.type !== p.OPERATOR &&
										this._flags.last_token.type !== p.START_EXPR &&
										(l(this._flags.last_token.type, [p.START_BLOCK, p.SEMICOLON]) && !this._flags.inline_frame
											? this.print_newline()
											: (this._output.space_before_token = !0))),
								this.print_token(t),
								this.indent(),
						...
						(T.prototype.handle_word = function (t) {
							...
							this._flags.last_token.type === p.END_BLOCK
								...
								f(t, r) &&
									')' !== this._flags.last_token.text &&
									(e =
										this._flags.inline_frame || 'else' === this._flags.last_token.text || 'export' === this._flags.last_token.text
											? 'SPACE'
											: 'NEWLINE'),
						...
						(T.prototype.handle_semicolon = function (t) {
							...
							for (
								var e = this._tokens.peek();
								!(this._flags.mode !== k || (this._flags.if_block && a(e, 'else')) || this._flags.do_block);
						...
						(T.prototype.handle_operator = function (t) {
							var e =
									...
									(f(this._flags.last_token, ['function', 'yield']) ||
										l(this._flags.last_token.type, [p.START_BLOCK, p.COMMA, p.END_BLOCK, p.SEMICOLON])),
								i =
									l(t.text, ['-', '+']) &&
									(l(this._flags.last_token.type, [p.START_BLOCK, p.START_EXPR, p.EQUALS, p.OPERATOR]) ||
							...
							if (
								...
								e
									? (this.allow_wrap_or_preserved_newline(t),
										(n = !1),
										(u = (_ = this._tokens.peek()) && l(_.type, [p.WORD, p.RESERVED])))
									: '...' === t.text
										? (this.allow_wrap_or_preserved_newline(t), (n = this._flags.last_token.type === p.START_BLOCK), (u = !1))
										: (l(t.text, ['--', '++', '!', '~']) || i) &&
											((this._flags.last_token.type !== p.COMMA && this._flags.last_token.type !== p.START_EXPR) ||
												this.allow_wrap_or_preserved_newline(t),
											(u = n = !1),
											!t.newlines ||
												...
												: this._flags.last_token.type === p.END_EXPR
													...
													: this._flags.last_token.type === p.OPERATOR &&
														((n =
															l(t.text, ['--', '-', '++', '+']) &&
															l(this._flags.last_token.text, ['--', '-', '++', '+'])),
														l(t.text, ['+', '-']) && l(this._flags.last_token.text, ['--', '++']) && (u = !0)),
											((this._flags.mode !== g || this._flags.inline_frame) && this._flags.mode !== k) ||
					...
					((p.prototype = new n())._is_comment = function (t) {
						...
						(p.prototype._is_closing = function (t, e) {
							return (
								...
								e &&
								((']' === t.text && '[' === e.text) || (')' === t.text && '(' === e.text) || ('}' === t.text && '{' === e.text))
							);
						}),
						...
						(p.prototype._read_pair = function (t, e) {
							var i = null;
							return (
								(i = '#' === t && '{' === e ? this._create_token(f.START_BLOCK, t + e) : i) &&
							...
							return (
								'/' === t &&
									...
									'*' === this._input.peek(1)
										...
										: '/' === this._input.peek(1) &&
											((t = this.__patterns.comment.read()), (i = this._create_token(f.COMMENT, t)))),
								i
							);
						}),
						...
						(p.prototype._read_regexp = function (t, e) {
							if ('/' === t && this._allow_regexp_or_xml(e)) {
								for (
									var i = this._input.next(), n = !1, u = !1;
									this._input.hasNext() && (n || u || this._input.peek() !== t) && !this._input.testChar(r.newline);
									...
									(i += this._input.peek()),
										n
											? (n = !1)
											: ((n = '\\' === this._input.peek()),
												'[' === this._input.peek() ? (u = !0) : ']' === this._input.peek() && (u = !1)),
										this._input.next();
								return (
									this._input.peek() === t && (i = (i += this._input.next()) + this._input.read(r.identifier)),
							...
							"'" === t
								...
								: '"' === t
									...
									: '`' === t
										...
										: '}' === t && (u = this.__patterns.template_expression);
							for (var n, u, _ = u.read(), s = ''; this._input.hasNext(); ) {
								...
								'\\' === s && this._input.hasNext()
									...
									: i &&
										...
										i === s &&
											((s += '`' === t ? this._read_string_recursive('}', e, '`') : this._read_string_recursive('`', e, '${')),
				...
				function (t) {
					...
					(e.prototype.restart = function () {
						...
						(e.prototype.readUntil = function (t, e) {
							...
							return (
								t ? ((i = t.index), e && (i += t[0].length)) : (i = this.__input_length),
					...
					(n.prototype.tokenize = function () {
						...
						for (var t, e = new _(o.START, ''), i = null, n = [], u = new s(); e.type !== o.EOF; ) {
							...
							u.isEmpty() || ((t.comments_before = u), (u = new s())),
								...
								this._is_opening(t)
									? (n.push(i), (i = t))
									: i && this._is_closing(t, i) && (((t.opened = i).closed = t), (i = n.pop()), (t.parent = i)),
								((t.previous = e).next = t),
								this.__tokens.add(t),
								(e = t);
						}
				...
				function (t, e, i) {
					...
					((u.prototype = new n()).__set_whitespace_patterns = function (t, e) {
						...
						(u.prototype.__split = function (t, e) {
							for (var i = (t.lastIndex = 0), n = [], u = t.exec(e); u; )
								n.push(e.substring(i, u.index)), (i = u.index + u[0].length), (u = t.exec(e));
				...
				function (t) {
					...
					(e.prototype.get_directives = function (t) {
						...
						for (var e = {}, i = ((this.__directive_pattern.lastIndex = 0), this.__directive_pattern.exec(t)); i; )
