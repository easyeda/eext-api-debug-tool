(function() {
    ...
    class WorkflowEngine {
        constructor() {
            ...
            this.interactionController = new window.WorkflowApp.InteractionController(this.canvas, this.state, this.eventBus, this.renderer.blockRenderer);
        ...
        registerApiBlocks() {
            ...
            edcode.forEach(item => {
                ...
                const BlockClass = class extends window.WorkflowApp.BaseBlock {
                    static getMetadata() { return metadata; }
                };
        ...
        bindEvents() {
            ...
            this.eventBus.on('blockDblClick', (block) => {
                if (this.propertiesPanel.panel.classList.contains('open') && this.propertiesPanel.currentBlock && this.propertiesPanel.currentBlock.id === block.id) {
