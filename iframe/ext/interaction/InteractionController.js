(function() {
    ...
    class InteractionController {
        constructor(canvas, state, eventBus, blockRenderer) {
            ...
            this.portTooltip.style.cssText = 'position:fixed;background:#1e1f1c;color:#f8f8f2;border:1px solid #49483e;border-radius:4px;padding:6px 10px;font:12px sans-serif;max-width:360px;word-wrap:break-word;pointer-events:none;z-index:9999;display:none;box-shadow:0 2px 8px rgba(0,0,0,0.5);';
        ...
        bindCanvasEvents() {
            this.canvas.addEventListener('mouseleave', () => { this.portTooltip.style.display = 'none'; });
